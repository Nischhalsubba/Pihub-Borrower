...
const dictionary = {
  en: {
    ...
    financingWorkspace: 'Financing', applicationsWorkspace: 'Applications', executionWorkspace: 'Execution', servicingWorkspace: 'Servicing', organizationWorkspace: 'Organization', sectionNavigationHint: 'Related tools stay together in one continuous workflow.',
  ...
  de: {
    ...
    financingWorkspace: 'Finanzierung', applicationsWorkspace: 'Anträge', executionWorkspace: 'Abwicklung', servicingWorkspace: 'Kreditverwaltung', organizationWorkspace: 'Organisation', sectionNavigationHint: 'Zugehörige Werkzeuge bleiben in einem durchgängigen Arbeitsablauf zusammen.',
